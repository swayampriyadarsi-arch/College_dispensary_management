    ...
    <div className='login-page'>
        <div className='login-page-card'>
           ...
           <div className='form-input-fields'>
            ...
            <input value={loginField.password} onChange={(event) => handleOnChange(event, 'password', 'login')} className='form-input' type="password" placeholder="Enter Password" />
        ...
        <div className='signup-page-card'>
           ...
           <div className='form-input-fields'>
            <input value={registerField.name} onChange={(event) => handleOnChange(event, 'name', 'register')} className='form-input' type="text" placeholder="Enter Name" />
            ...
            <input value={registerField.password} onChange={(event) => handleOnChange(event, 'password', 'register')} className='form-input' type="password" placeholder="Enter Password" />
            <input value={registerField.roll} onChange={(event) => handleOnChange(event, 'roll', 'register')} className='form-input' type="text" placeholder="Enter your Registration no" />
            <div className='form-button'>
